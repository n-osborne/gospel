...
val add_unsupported_ocaml_type : env -> Ident.t -> env
...
val is_unsupported_ocaml_type : mod_defs -> Parse_uast.qualid -> bool
(** [is_unsupported_ocaml_type defs id] decides whether the type name [id]
